...
<div class="container">
	<form id="frm01" class="form-inline"  method="post">
  	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
	    <input name="dname" value="${dept.dname}" class="form-control mr-sm-2" placeholder="부서이름" />
   ...
   <table class="table table-hover table-striped">
    ...
    <tbody>
    	...
    	<tr><td>${d.deptno}</td><td>${d.dname}</td>
    		<td>${d.loc}</td></tr>
    	</c:forEach>
    </tbody>
	</table>    
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
	     ...
	     <div class="row">
	      <div class="col">
	        <input name="deptno" type="text" 
	        	class="form-control" placeholder="부서번호 입력" >
	      </div>
	      <div class="col">
      ...
      <div class="modal-footer">
        ...
        <button type="button" onclick="insertDept()" class="btn btn-primary">부서 등록</button>
      </div> <%-- 15:05~ --%>
    </div>
  </div>
</div>
