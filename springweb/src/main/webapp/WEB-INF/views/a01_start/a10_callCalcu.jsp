...
<div class="jumbotron text-center">
  <h2 data-toggle="modal" data-target="#exampleModalCenter">총계계산</h2>
...
<div class="container">
	<form id="frm01" class="form-inline"  method="post">
	  ...
	  <%--
	  action="${path}/call11.do"
	  현재 view을 호출하는 action과 이름이 같으면 생략 가능
	   --%>
 	</nav>
	</form>
   <table class="table table-hover table-striped">
    ...
    <tbody>
    	<tr><td>${param.price}</td><td>${param.cnt}</td><td>${calcu}</td></tr>
    </tbody>
	</table>    
	<%--
