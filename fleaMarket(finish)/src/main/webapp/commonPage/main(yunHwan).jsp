...
<body class="g-sidenav-show bg-gray-100">
   ...
   <!-- Start Navbar -->
        ...
        <div class="col-lg-5">
          <div class="card card-carousel overflow-hidden h-100 p-0">
            <div id="carouselExampleCaptions" class="carousel slide h-100" data-bs-ride="carousel">
              <div class="carousel-inner border-radius-lg h-100" style="margin-right:0px;">
    ...
    <div id="carouselExampleIndicators" class="carousel slide slidew" data-bs-ride="carousel">
