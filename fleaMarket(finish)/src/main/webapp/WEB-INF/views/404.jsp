...
<body class="error-page">
  ...
  <main class="main-content  mt-0">
    <div class="page-header min-vh-100" style="background-image: url('${path}/assets/img/illustrations/404.svg');">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-6 col-md-7 mx-auto text-center">
            ...
            <button type="button" class="btn bg-gradient-dark mt-4" onclick="location.href='${path}/callmain.do'">Go to Homepage</button>
          </div>
        </div>
      </div>
    </div>
