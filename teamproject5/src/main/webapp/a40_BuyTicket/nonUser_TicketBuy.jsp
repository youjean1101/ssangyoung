...
<body>
	...
	<tbody>
		...
		<tr><th>생년월일</th>
			<td><select id="ageck" class="inputBox" >
					<c:forEach var="i" begin="1923" end="2023">
						<option>${i}</option>
					</c:forEach>
				</select>년
		...
		<tr><th>결제금액</th><td><span class="price">1000</span> 원</td></tr>
		<tr><th>이름</th>
