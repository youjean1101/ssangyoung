...
<script type="text/javascript">
	$(document).ready(function(){
		$("#rentalnumberSeaButt").css({"background":"white","color":"black"})
		...
		$("#goBuyTicketButt").click(function(){
			$("#noneUserViewTab").css("display","none")
	...
	<table id="noneUserViewTab">
		...
		<thead>
			<tr><th>결제상품</th><th>금액</th><th>결제방법</th>
				<th>대여날짜</th><th>사용시간</th></tr>
		</thead>
		<tbody>
			<c:forEach var="nRlist" items="${nonUserRentalList}">
			<tr><td>${nRlist.ticketKind}</td><td>${nRlist.payMoney}</td><td>${nRlist.payMethod}</td>
				<td>${nRlist.rentalTime}</td>
