  ...
  <main class="main-content position-relative border-radius-lg">
          ...
          <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
            <div class="nav-wrapper position-relative end-0">
              <ul class="nav nav-pills nav-fill p-1" role="tablist">
                <li class="nav-item">
                  <a class="nav-link mb-0 px-0 py-1 active d-flex align-items-center justify-content-center " style="background:white;" data-bs-toggle="tab" href="javascript:;" role="tab" aria-selected="true">
    ...
    <div class="container-fluid py-4">
     ...
     <div class="row">
      ...
      <div class="mt-3 kanban-container" style="width:1260px;">
