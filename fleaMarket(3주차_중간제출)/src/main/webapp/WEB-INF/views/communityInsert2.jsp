              ...
              <li class="nav-item ">
                ...
                <div class="collapse show" id="projectsExample">
                  <ul class="nav nav-sm flex-column">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active" href="${path}/pages/pages/projects/new-project.html">
                        <span class="sidenav-mini-icon text-xs"> N </span>
	  ...
	  <div class="col-md-4">
	    <div class="card">
	      <div class="card-body text-center">
	        <p class="card-text">왜안되지</p>
	        <button class="btn btn-primary mb-0" onclick="argon.showSwal('input-field')">삭제하기 테스트</button>
	      </div>
	    </div>
	  </div>
  </div>
  <!-- 삭제하기 알람창  -->
  <script src="${path}/assets/js/plugins/sweetalert.min.js"></script>
  <!--   Core JS Files   -->
