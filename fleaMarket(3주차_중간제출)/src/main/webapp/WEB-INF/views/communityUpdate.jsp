	...
	<form method="post" enctype="multipart/form-data" action="${path}/communityUpdate.do"><!--  -->
      ...
      <div class="row mt-4" >
         <div class="card h-100" style="margin-top:8%;">
           <div class="card-body">
             <h5 class="font-weight-bolder" style="text-align:center; font-size:20pt;"><span>커뮤니티</span> 게시글 변경</h5><!--(조건걸어서 무슨커뮤니티인지 넣기)  -->
             <div class="row">
               <div class="col-12">
                 <div class="card-body">
              <div class="row">
	              	<label for="fileClick1" style="margin-left:32%;">
	                  <img class="border-radius-lg shadow-lg" alt="chair" style="width:600px; height:400px;"
            ...
            <div class="card-body">
              ...
              <div class="row" style="--bs-gutter-x:0;">
                <div class="col-12 col-sm-6">
	               ...
	               <input class="form-control" onclick="updateImpossible('카테고리')" value="카테고리값" 
	               	type="text" readonly style="width:90%;"/>
                </div>
                <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                  <label class="postUpdateTitle">작성자</label>
                  <input class="form-control" onclick="updateImpossible('작성자')" 
                  	value="${Login.email}" type="text" readonly style="width:90%;"/>
                </div>
              </div>
              <div class="row" style="--bs-gutter-x:0;">
