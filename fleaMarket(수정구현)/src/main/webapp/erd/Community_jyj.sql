...
CREATE TABLE friend
(
	email varchar2(50) NOT NULL, -- 회원 이메일(FK 처리)
	follower varchar2(50) NOT NULL
);
DROP TABLE friend CASCADE CONSTRAINTS;

INSERT INTO friend VALUES('dbwls8382@naver.com','28888wjdaud@naver.com');
...
WHERE f.follower=m.email
AND f.follower=pro.email;
