...
function callPageSelector(){
	   ...
	   const rows = document.querySelectorAll('.card-plain');// 게시글 row를 전체 선택
	   //console.log(rows);
	   ...
	   const numbers = document.querySelector('#pagenum'); //클릭할 페이지 버튼번호가 생성될 ol
	   //변수 추가 이전다음버튼
	   ...
	   for(let i=1; i<=PageCount;i++){
	      numbers.innerHTML +='<li class="page-item"><a href="">'+i+'</a></li>' //생성될 페이지 갯수만큼 버튼li 생성
