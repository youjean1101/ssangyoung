...
<div class="jumbotron text-center">
  <h2 data-toggle="modal" data-target="#exampleModalCenter">회원등록</h2>
...
<div class="container">
	<form id="frm01" class="form-inline"  method="post">
  	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
	    ...
	    <input type="password" name="password" class="form-control mr-sm-2" placeholder="패스워드" />
   ...
   <table class="table table-hover table-striped">
    ...
    <tbody>
    	<tr><td>${param.id}</td><td>${param.name}</td><td>${param.password}</td><td>${param.auth}</td><td>${param.point}</td></tr>
    </tbody>
	</table>    
