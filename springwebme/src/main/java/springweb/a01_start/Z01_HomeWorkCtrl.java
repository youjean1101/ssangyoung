...
//   *2) 아이디와 패스워드를 입력하여 인증 여부 모델로 설정하고 화면에 출력하세요(get/post 구분)
	...
	public String login90() {
		return "WEB-INF\\views\\z01_homwork\\a01_loginFrm.jsp";
	}
 ...
 * 		 모델데이터로 임의의 2~9, 1~9 전달되게 처리 한다.
 *       화면에 form 안에 [ 3 ] X  [ 4 ] ? [ @@@ ] [정답확인]
 *       형식으로 임의의 모델데이터를  input의 value값으를 전달하게 한다.
 *       	모델데이터 rGrade, rCnt (문제제출),  msg(정답처리)

 *       요청값 : grade, cnt, inRelpy로 선언하여 전달한다.
 *       @RequestParam(value="grade", 
 *       	defaultValue = "0") int grade
 ...
 * */
	...
	public String gugu100(
		...
		return "WEB-INF\\views\\z01_homwork\\a02_guguFrm.jsp";
	}
...
// http://localhost:7080/springweb/game10.do
	...
	public String game10(
			@RequestParam(value="mySel", 
				defaultValue = "-1") int myIdx,
			Model d) {
		...
		return "WEB-INF\\views\\z01_homwork\\a03_gameFrm.jsp";
	}
 ...
 * */
	...
	public String kimbap(Kimbap kb) {
		...
		return "WEB-INF\\views\\z01_homwork\\a04_kimbapFrm.jsp";
	}
