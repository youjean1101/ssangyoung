...
framePosition.innerHTML = "<iframe src='salesingSalesVIew.jsp' name='buyreserve' width='100%' height='500'></iframe>"
...
dealSuccessOb.onclick=function(){
	...
	hiddenhrOb.innerHTML=""
	framePosition.innerHTML = "<iframe src='dealSuccessSalesView.jsp' name='buyreserve' width='100%' height='500'></iframe>"
}
//-------------------------숨김처리된 구매내역 조회기능메서드------------------------------------
...
hiddenOb.onclick=function(){
	...
	salesinghrOb.innerHTML=""
	dealsucchrOb.innerHTML=""
	framePosition.innerHTML = "<iframe src='hiddenSalesView.jsp' name='buyreserve' width='100%' height='500'></iframe>"
}
